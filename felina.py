...
class BlorbAI:
    def __init__(self, openai_api_key, name="Felina AI"):
    ...
    def custom_logic(self, task_type, **kwargs):
        """
        Handles specific tasks or logic for Felina AI.
        """
...
if __name__ == "__main__":
    ...
    felina = BlorbAI(openai_api_key=API_KEY)

    # Main Chat Interface
    felina.run_chat()

    # Example of custom functionality
    text_to_summarize = "Felina AI is a powerful AI assistant that can handle multiple tasks."
    print("\nSummarizing text:")
    print(felina.custom_logic(task_type="summarize", text=text_to_summarize))
